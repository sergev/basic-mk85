...
int input_line_editor(void)
{
    const struct {
        char keychar;
        char *keyword;
    } tab0021[TAB0021_SIZE] = { /* index 0: empty table */
                                { 0, "" },
        ...
        if (i <= 0x0A) {
            ...
            case 9: /* 05D8: ANS */
                if ((mode & 0x0030) != 0) {
                    ...
                    fp2str(read64(0x8224 /*variable ANS*/), -10, &ram[0x8060u - RAMSTART]);
            ...
            if (x == 0) {
                ...
                /* 01B8: */
                    ...
                    if (i == '+' || i == '-' || i == '*' || i == '/' || i == '^') {
                         ...
                         */
                        fp2str(read64(0x8224 /*variable ANS*/), -10, &ram[0x816Du - RAMSTART]);
...
void mode1(void)
{
    ...
    ram[0x8269u /*cursor position*/ - RAMSTART] = ram[0x8268u /*selected program*/ - RAMSTART] + 2;
    ram[0x8265u - RAMSTART] |= 0x80;
    /* 03B0: 0BA0: */
    ram[0x8264u - RAMSTART] &= 0x20;
}
...
void arrow_left(void)
{
    ...
    bufpos = read16(0x8260);
    if ((ram[0x8264u - RAMSTART] & 0x80) != 0 && ram[0x8269u /*cursor position*/ - RAMSTART] != 0) {
        /* 047C: */
...
{
    return read16(0x8252 /*top of the RAM*/) - 8 * read16(0x8250 /*number of variables*/) -
